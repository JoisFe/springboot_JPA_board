...
public class CommentController {
    ...
    public String uploadComment(@Valid CommentDto commentDto, BindingResult errors, HttpServletRequest req) {
        if (!memberService.commentWriterTest(commentDto.getAuthor().getUsername(), req)) return "현재 로그인한 아이디와 작성자가 다릅니다.";
    ...
    @ResponseBody
    public String updateComment(@Valid CommentDto commentDto, BindingResult errors, HttpServletRequest req) {
